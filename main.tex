...
\vspace{6pt}\noindent {\large Adam J. Calhoun$^{1,*}$, Ahmed El Hady $^{1,2,3,*}$}

\vspace{6pt}

\noindent{\small $1$. Princeton Neuroscience Institute, Princeton University, Princeton, United States. 
\noindent \small $2$. Cluster for Advanced Study of Collective Behavior, University of Konstanz.
\noindent \small $3$. Max Planck Institute of Animal Behavior, Konstanz.

\noindent * correspondence should be addressed to Ahmed El Hady (ahady@ab.mpg.de) or Adam Calhoun (adam.calhoun@gmail.com)}
